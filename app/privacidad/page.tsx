  ...
  return (
    <main className="legal-page">
      ...
      <article className="legal-document">
        ...
        <section><h2>6. Marco legal aplicable</h2><p>El tratamiento de datos y la atención en BIOBELLE se rigen estrictamente por la legislación chilena:</p><ul><li><b>Ley N.º 20.584:</b> Regula los Derechos y Deberes que tienen las personas en relación con acciones vinculadas a su atención en salud.</li><li><b>Ley N.º 19.628:</b> Sobre Protección de la Vida Privada y Tratamiento de Datos Personales.</li><li><b>Código Sanitario (DFL 725) y Decretos MINSAL:</b> Normativa sanitaria para establecimientos y prestaciones de salud.</li><li><b>Ley N.º 19.496:</b> Sobre Protección de los Derechos de los Consumidores.</li></ul></section>
        <p className="legal-note">Esta política rige el agendamiento y atención en BIOBELLE. Los consentimientos informados clínicos específicos para cada procedimiento se suscriben previo a la realización de la sesión.</p>
      </article>
    </main>
  );
}
